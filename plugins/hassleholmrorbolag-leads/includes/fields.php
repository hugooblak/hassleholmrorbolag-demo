...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'hassleholmrorbolag-leads' ),
				'storm'       => __( 'Storm or hail damage', 'hassleholmrorbolag-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'hassleholmrorbolag-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'hassleholmrorbolag-leads' ),
				'not-sure'    => __( 'Vet inte än', 'hassleholmrorbolag-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'hassleholmrorbolag-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'hassleholmrorbolag-leads' ),
				'research' => __( 'Jag kollar bara priser', 'hassleholmrorbolag-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'hassleholmrorbolag-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'hassleholmrorbolag-leads' ),
		'contacted' => __( 'Kontaktad', 'hassleholmrorbolag-leads' ),
		'quoted'    => __( 'Quote sent', 'hassleholmrorbolag-leads' ),
		'won'       => __( 'Won', 'hassleholmrorbolag-leads' ),
		'lost'      => __( 'Lost', 'hassleholmrorbolag-leads' ),
		'spam'      => __( 'Misstänkt spam', 'hassleholmrorbolag-leads' ),
	);
}
