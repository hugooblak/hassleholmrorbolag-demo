 ...
 * Slug: hassleholmrorbolag/storm-steps
...
<div class="wp-block-group alignfull ha-sec-steps" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:heading {"align":"wide"} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"className":"ha-step-num"} -->
<p class="ha-step-num"><?php echo (int) $i + 1; ?></p>
<!-- /wp:paragraph -->
